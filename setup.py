...
# Arguments marked as "Required" below must be included for 0.9.11upload to PyPI.
...
setup(
    ...
    url='https://github.com/orthanc-team/python-orthanc-tools',  # Optional
